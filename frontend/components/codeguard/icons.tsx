...
export function SparkleIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="currentColor">
      <path d="M12 2l1.5 5.5L19 9l-5.5 1.5L12 16l-1.5-5.5L5 9l5.5-1.5L12 2zm-7 14l1 3.5L9.5 20l-3.5 1-1-3.5L1.5 16l3.5-1 1-3.5zm14 0l1 3.5 3.5 1-3.5 1-1 3.5-1-3.5-3.5-1 3.5-1 1-3.5z" />
    </svg>
  );
}
...
export function NavIcon({ name, className = "w-4 h-4" }: { name: string; className?: string }) {
  const paths: Record<string, string> = {
    ...
    "git-pull": "M7 4v6m0 0l-2-2m2 2l2-2M17 14v6m0 0l-2-2m2 2l2-2",
...
export function WarningShieldIcon({ className = "w-4 h-4" }: { className?: string }) {
  return (
    <svg className={className} viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      <path d="M12 2L4 5v6c0 5.25 3.5 10 8 11 4.5-1 8-5.75 8-11V5l-8-3z" />
